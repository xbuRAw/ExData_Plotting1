...
# sub plot 2
plot(powerData[, dateCol], powerData[, Voltage], type = "l", xlab = "dateCol", ylab = "Voltage")
...
# sub plot 4
plot(powerData[, dateCol], powerData[, Global_reactive_power], type = "l", xlab = "dateCol", ylab = "Global_reactive_power")
